<template>
    ...
    <div class="header">
        ...
        <div class="header-card">
            <p>Привет, меня зовут Алёна! Я фотографирую с самого подросткового возраста и за это время я успела полюбить искренние эмоции и яркие улыбки людей    на своих фото-карточках. Буду рада, если вы окажетесь следующими, чьи живые снимки пополнят мою коллекцию</p>
        </div>
        <img class="" src="@/assets/photos/alena/a.png">
        <p class="name">Алена Ишметова</p>
    ...
    <div class="portfolio">
        ...
        <div class="portfolio-section">
            ...
            <div class="portfolio-studio">
                <div class="portfolio-section-main">
                    <img class="studio-main" src="@/assets/photos/alena/studio/img-8391.webp">
                </div>
                
                <div class="carousel-full">
                    <div class="button-left" id="button-left" v-on:click="swipeLeft('studio')"></div>
                    <div class="carousel">
                        <Card id="studio-card1" :imgUrl="alena_studio[0].img" :data-id="0"/>
                        <Card id="studio-card2" :imgUrl="alena_studio[1].img" :data-id="1"/>
                        <Card id="studio-card3" :imgUrl="alena_studio[2].img" :data-id="2"/>
                    </div>
        ...
        <div class="portfolio-section">
            ...
            <div class="portfolio-street">
                <div class="portfolio-section-main">
                    <img class="street-main" src="@/assets/photos/alena/street/img-3036.webp">
                </div>
                <div class="carousel-full">
                    <div class="button-left" id="button-left" v-on:click="swipeLeft('street')"></div>
                    <div class="carousel">
                        <Card id="street-card1" :imgUrl="alena_street[0].img" :data-id="0"/>
                        <Card id="street-card2" :imgUrl="alena_street[1].img" :data-id="1"/>
                        <Card id="street-card3" :imgUrl="alena_street[2].img" :data-id="2"/>
                    </div>
...
<script setup>
    ...
    function swipeLeft(topic) {
        ...
        let length = 0
        if (topic == 'studio') {
            length = alena_studio.length - 1
        } else {
            length = alena_street.length - 1
        }
        for (let i = 0; i < 3; i++) {
        ...
        if (topic == 'studio') {
            card1.firstChild.firstChild.src=alena_studio[card1.dataset.id].img
            card2.firstChild.firstChild.src=alena_studio[card2.dataset.id].img
            card3.firstChild.firstChild.src=alena_studio[card3.dataset.id].img
        } else {
            card1.firstChild.firstChild.src=alena_street[card1.dataset.id].img
            card2.firstChild.firstChild.src=alena_street[card2.dataset.id].img
            card3.firstChild.firstChild.src=alena_street[card3.dataset.id].img
        }
    }
